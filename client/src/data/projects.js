const PROJECTS = [
  ...
  {
    _id: 'codehawks-eggstravaganza-2025',
...
export const PROJECTS_DATA = [...PROJECTS].sort((a, b) => a.order - b.order);
export const FEATURED_PROJECTS = PROJECTS_DATA.filter((project) => project.featured).slice(0, 3);
